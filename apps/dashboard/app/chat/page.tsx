...
import { Send, Bot, User, ChevronDown, Loader2, Code2 } from "lucide-react";
    ...
    try {
      ...
      setMessages((m) => m.map((msg) =>
        msg.id === loadingMsg.id
          ? { ...msg, loading: false, content: `Fel: ${(e as Error).message}`, error: (e as Error).message }
          : msg,
      ));
    } finally {
      setLoading(false);
      ...
      <div className="shrink-0 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-ink-400 font-medium mt-0.5">Ställ frågor om kod, arkitektur eller blockers — agenten söker i era GitHub-repos</p>
          </div>
        </div>
      </div>
